...
## Navigation rapide
> **[`knowledge/impulse.md`](./knowledge/impulse.md)** — source unique de vérité métier (identité, programme ambassadeur, catalogue, SAV, voice, runbooks, glossaire, quirks).
>
> Ancres utiles :
> - [3 modèles de partenariat](./knowledge/impulse.md#2-programme-ambassadeur--les-3-modèles) (Affiliation / Dotation / Paid)
> - [Pipeline ambassadeur + statuts](./knowledge/impulse.md#3-pipeline-ambassadeur)
> - [Catalogue produits](./knowledge/impulse.md#4-catalogue-produits) (SKU/variant_id = Shopify MCP)
> - [SAV & opérations client](./knowledge/impulse.md#5-sav--opérations-client) (Gorgias → Shopify → BigBlue, tags CA)
> - [Voice & persona split](./knowledge/impulse.md#6-voice--persona-split)
> - [Runbooks condensés](./knowledge/impulse.md#7-runbooks-opérationnels-condensés) (codes, orders, credits)
> - [Glossaire](./knowledge/impulse.md#8-glossaire-métier)
> - [Quirks techniques](./knowledge/impulse.md#9-quirks-techniques-transverses)
>
...
→ **JAMAIS signer "Antoine" côté SC**, même si c'est lui qui rédige. Le client final achète à une marque, pas à une personne. Détails dans [`knowledge/impulse.md#6-voice--persona-split`](./knowledge/impulse.md#6-voice--persona-split).
...
Référence humaine : [`knowledge/impulse.md#6-voice--persona-split`](./knowledge/impulse.md#6-voice--persona-split). Corpus ton : [`instagram_dm_mcp/personality.md`](./instagram_dm_mcp/personality.md).
...
Référence humaine : [`knowledge/impulse.md#5-sav--opérations-client`](./knowledge/impulse.md#5-sav--opérations-client). Persona : [`gorgias_mcp/personality.md`](./gorgias_mcp/personality.md).
