...
export function registerOrderTools(server, client) {
    server.registerTool("list_orders", {
        title: "List Orders",
        description: "List TikTok Shop orders with optional filters. Returns order summaries including status, total amount, items, and buyer info.",
        inputSchema: {
    ...
    server.registerTool("get_order_detail", {
        ...
        description: "Get detailed information about one or more orders by their IDs.",
        inputSchema: {
