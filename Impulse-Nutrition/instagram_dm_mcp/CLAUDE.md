...
>
> Référence humaine (templates complets, voice, red flags) : [`../knowledge/voice/rules.md`](../knowledge/voice/rules.md). Source machine-readable des templates : [`../knowledge/voice/templates.yaml`](../knowledge/voice/templates.yaml).
>
