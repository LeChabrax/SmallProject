...
- `search_tickets` fonctionne via custom implementation (email lookup + substring fallback, cf `reference_mcps.md` §2) — n'est **pas** un full-text search. Utiliser le pull protocol 100+ comme filet de sécurité.
